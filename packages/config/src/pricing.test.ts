...
import { DEFAULT_EBS_GB_MONTH_USD, DEFAULT_FARGATE_VCPU_HOUR_USD, workspacePricing } from "./index";
...
// Snapshot the pricing env before each test and restore after, so a test
