...
# up the dev substrate (DynamoDB Local + any tiers in EDD_DEV_PROFILES, e.g.
# "github" or "github aws"), seeds the local table idempotently, then starts
...
# Optional tiers (compose profiles): EDD_DEV_PROFILES="github aws", etc.
profiles=""
