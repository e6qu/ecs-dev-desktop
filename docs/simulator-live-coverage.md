...
| Golden workspace SSH path                               | AWS container-mode sim plus the golden workspace image                                                                              | The image now includes `sshd`/CA/principal wiring, but full live e2e is blocked by sockerless #526/#527. Restore when upstream fixes land. |
